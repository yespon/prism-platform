...
class TestAsyncExecutionPath:
    ...
    @pytest.mark.anyio
    async def test_aexecute_forwards_user_and_tenant_context(self, classes, base_config, mock_agent, msg):
        """Subagent must forward user/tenant identifiers for middleware that requires them."""
        SubagentExecutor = classes["SubagentExecutor"]
        SubagentStatus = classes["SubagentStatus"]
