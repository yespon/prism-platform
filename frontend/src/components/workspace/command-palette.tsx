...
export function CommandPalette() {
  ...
  const shortcuts = useMemo(
    ...
    [handleNewChat, handleShowShortcuts],
  );
  ...
  useEffect(() => {
    ...
    window.addEventListener("workspace:open-command-palette", handleOpen);
    return () => {
      window.removeEventListener("workspace:open-command-palette", handleOpen);
    };
  }, []);
