...
/**
 * Extensions that browsers can render inline (images, PDF, video, audio).
 * All other binary files (PPT, DOCX, XLSX, ZIP, etc.) will show a download prompt.
 */
...
export function isPreviewableInBrowser(filepath: string): boolean {
